...
const GUIDES = {
    startReward: {
        ...
        lines: [
            "从三张奖励卡中任选一项作为开局加成。",
            "奖励分三类：加成（数值提升）/ 技能（主动释放）/ 能力（被动与局外收益）。",
