...
export const REWARD_DATA = [
    ...
    { id: "energy_shield", name: "岿然不动", icon: "🌀", rarity: "uncommon", type: "skill", cooldown: 30, desc: "8 秒内挡板免疫一切弹幕伤害" },
    { id: "blast_charge", name: "爆裂蓄力", icon: "💥", rarity: "uncommon", type: "skill", cooldown: 25, desc: "接下来 5 秒内击碎方块时引发爆炸，波及周围方块" },
    { id: "barrage", name: "弹幕爆发", icon: "🎇", rarity: "uncommon", type: "skill", cooldown: 35, desc: "立即额外发射 5 个球" },
    { id: "power_strike", name: "突破极限", icon: "🔆", rarity: "rare", type: "skill", cooldown: 30, desc: "接下来 5 秒内球伤害 ×2" },
    ...
    { id: "vampire", name: "死亡收割", icon: "🧛", rarity: "rare", type: "ability", maxStacks: 2, desc: "击碎方块时有 2.5% 概率恢复 1 条生命" },
    ...
    { id: "vampiric_gem", name: "吸血宝石", icon: "💎", rarity: "rare", type: "ability", maxStacks: 1, tierLock: 1, desc: "击碎方块时 5% 概率恢复 1 生命" },
