...
export const REWARD_DATA = [
    ...
    { id: "energy_shield", name: "能量护盾", icon: "🌀", rarity: "uncommon", type: "skill", cooldown: 30, desc: "8 秒内挡板免疫一切弹幕伤害" },
    ...
    { id: "power_strike", name: "聚能一击", icon: "🔆", rarity: "rare", type: "skill", cooldown: 30, desc: "接下来 5 秒内球伤害 ×2" },
